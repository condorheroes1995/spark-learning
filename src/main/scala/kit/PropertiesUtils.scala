...
object PropsUtils {
    ...
    val confMap: Map[String, String] = getPropertiesFromLocalFile("default.properties")
    ...
    def getPropertiesFromHDFSFile(path: String): Map[String, String] = {
        ...
        try {
            ...
            case e: Exception =>
                throw new Exception(s"Failed when loading  properties from $path", e)
        }
    }
    ...
    def getPropertiesFromLocalFile(fileName: String): Map[String, String] = {
        try {
            ...
            case e: Exception =>
                throw new Exception(s"Failed when loading  properties from $fileName", e)
        }
    }
